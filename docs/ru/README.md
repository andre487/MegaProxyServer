...
- `probe_resistance`: настройки ложного ответа для неаутентифицированных запросов.
...
и передаёт соединение отдельному GOST listener на loopback. Затем entry подключается к выбранному
exit по машинным реквизитам.
...
- Probe resistance скрывает протокол от неаутентифицированных HTTP-проб, но не IP сервера или SNI.
